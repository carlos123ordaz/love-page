            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        style={{ position: 'fixed', bottom: 0, left: 0, right: 0, background: 'var(--paper)', borderTop: '2px solid var(--ink)', borderRadius: '24px 24px 0 0', zIndex: 50, overflow: 'hidden', display: 'flex', flexDirection: 'column', maxHeight: height }}
                    >
                        <div style={{ flexShrink: 0, paddingTop: 12, paddingBottom: 8, paddingLeft: 16, paddingRight: 16 }}>
                            <div style={{ width: 40, height: 4, background: 'var(--ink)', borderRadius: 999, margin: '0 auto', opacity: 0.2 }} />
                        </div>
                        {title && (
                            <div style={{ flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 20px 12px', borderBottom: '1.5px dashed var(--rule)' }}>
                                ...
                                <button
                                    onClick={onClose}
                                    style={{ width: 32, height: 32, borderRadius: 999, border: '2px solid var(--ink)', background: 'white', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '2px 2px 0 var(--ink)' }}
                                >
...
function StatChip({ icon, value, label, color }: { icon: React.ReactNode; value: string | number; label: string; color: string }) {
    return (
        <div style={{ border: '2px solid var(--ink)', borderRadius: 20, background: 'white', boxShadow: '4px 4px 0 var(--ink)', padding: '16px 12px', textAlign: 'center' }}>
    ...
    const qrModalContent = user.isPro ? (
        <>
            <div style={{ padding: '8px 24px 24px', textAlign: 'center' }}>
                {generatingQr ? (
                    <div style={{ padding: '64px 0' }}>
                        <div style={{ width: 40, height: 40, borderRadius: 999, border: '3px solid var(--lila)', borderTopColor: 'var(--accent-hex)', animation: 'spin 1s linear infinite', margin: '0 auto 12px' }} />
                        <p style={{ fontSize: 13, color: 'var(--ink-soft)' }}>{t.pageDetail.generatingQR}</p>
                    </div>
                ) : qrDataUrl ? (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                        <div style={{ background: 'var(--lila-soft)', borderRadius: 16, padding: 12, border: '2px solid var(--ink)', display: 'inline-block' }}>
            ...
            {qrDataUrl && (
                ...
                >
                    ...
                    <button onClick={copyQrToClipboard} style={{ flex: 1, padding: '12px 16px', border: '2px solid var(--ink)', background: 'white', borderRadius: 999, fontSize: 13, fontWeight: 600, cursor: 'pointer', boxShadow: '2px 2px 0 var(--ink)', color: 'var(--ink)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
        ...
        <>
            <div style={{ background: 'var(--butter)', borderBottom: '2px solid var(--ink)', padding: '28px 24px', textAlign: 'center' }}>
                <div style={{ width: 64, height: 64, borderRadius: 999, background: 'white', border: '2px solid var(--ink)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 12px', boxShadow: '3px 3px 0 var(--ink)' }}>
            ...
            <div style={isMobile ? { padding: 24, paddingBottom: 'calc(24px + env(safe-area-inset-bottom))' } as React.CSSProperties : { padding: 24 }}>
                <div style={{ background: 'var(--lila-soft)', borderRadius: 16, padding: 24, border: '2px solid var(--ink)', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
                    ...
                    <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <div style={{ width: 48, height: 48, borderRadius: 999, background: 'white', border: '2px solid var(--ink)', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '3px 3px 0 var(--ink)' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                    <Link href="/upgrade">
                        <button style={{ width: '100%', padding: '14px 20px', background: 'var(--butter)', border: '2px solid var(--ink)', borderRadius: 999, fontSize: 14, fontWeight: 700, cursor: 'pointer', boxShadow: '3px 3px 0 var(--ink)', color: 'var(--ink)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
            ...
            <main style={{ maxWidth: 960, margin: '0 auto' }} className="px-5 pb-20 sm:px-8">
                ...
                <section style={{ padding: '32px 0 24px', display: 'flex', alignItems: 'flex-start', gap: 16 }}>
                    <button
                        ...
                        style={{ width: 40, height: 40, borderRadius: 999, border: '2px solid var(--ink)', background: 'white', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '3px 3px 0 var(--ink)', flexShrink: 0, marginTop: 4 }}
                    >
                    ...
                    <div style={{ display: 'flex', gap: 8, flexShrink: 0, marginTop: 4 }}>
                        <button onClick={handleCopyUrl} style={{ padding: '10px 16px', border: '2px solid var(--ink)', background: 'white', borderRadius: 999, fontSize: 12, fontWeight: 600, cursor: 'pointer', boxShadow: '2px 2px 0 var(--ink)', color: 'var(--ink)', display: 'flex', alignItems: 'center', gap: 6 }}>
                            <Copy style={{ width: 14, height: 14 }} />
                ...
                {/* ── Stats strip ── */}
                <section style={{ border: '2px solid var(--ink)', background: 'white', borderRadius: 24, boxShadow: '5px 5px 0 var(--ink)', marginBottom: 24 }} className="p-5 sm:p-7 grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                {stats?.totalResponses > 0 && (
                    <section style={{ border: '2px solid var(--ink)', background: 'white', borderRadius: 20, boxShadow: '4px 4px 0 var(--ink)', padding: '20px 24px', marginBottom: 24 }}>
                        ...
                        <div style={{ height: 12, background: 'var(--lila-soft)', borderRadius: 999, overflow: 'hidden', border: '1.5px solid var(--ink)' }}>
                ...
                {/* ── QR card ── */}
                <section style={{ border: user.isPro ? '2px solid var(--ink)' : '2px dashed var(--ink)', background: user.isPro ? 'white' : 'var(--butter)', borderRadius: 20, boxShadow: user.isPro ? '4px 4px 0 var(--ink)' : '4px 4px 0 var(--ink)', padding: '20px 24px', marginBottom: 24, display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 14, minWidth: 0 }}>
                        <div style={{ width: 44, height: 44, borderRadius: 14, border: '2px solid var(--ink)', background: user.isPro ? 'var(--lila)' : 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, boxShadow: '2px 2px 0 var(--ink)' }}>
                    ...
                    <button
                        ...
                        style={user.isPro
                            ? { padding: '10px 18px', border: '2px solid var(--ink)', background: 'var(--accent-hex)', color: 'white', borderRadius: 999, fontSize: 12, fontWeight: 700, cursor: 'pointer', boxShadow: '2px 2px 0 var(--ink)', display: 'flex', alignItems: 'center', gap: 6, flexShrink: 0 }
                            : { padding: '10px 18px', border: '2px solid var(--ink)', background: 'white', color: 'var(--ink)', borderRadius: 999, fontSize: 12, fontWeight: 700, cursor: 'pointer', boxShadow: '2px 2px 0 var(--ink)', display: 'flex', alignItems: 'center', gap: 6, flexShrink: 0 }}
                    >
                        {user.isPro ? (
                        ...
                        {showQrModal && (
                            ...
                            >
                                <motion.div
                                    ...
                                    style={{ background: 'var(--paper)', border: '2px solid var(--ink)', borderRadius: 28, boxShadow: '8px 8px 0 var(--ink)', maxWidth: 400, width: '100%', overflow: 'hidden' }}
                                ...
                                >
                                    {user.isPro && (
                                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '24px 24px 12px', borderBottom: '1.5px dashed var(--rule)' }}>
                                            ...
                                            <button onClick={closeQrModal} style={{ width: 32, height: 32, borderRadius: 999, border: '2px solid var(--ink)', background: 'white', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '2px 2px 0 var(--ink)' }}>
                ...
                {/* ── Page info ── */}
                <section style={{ border: '2px solid var(--ink)', background: 'white', borderRadius: 20, boxShadow: '4px 4px 0 var(--ink)', marginBottom: 24 }}>
                    ...
                    <div style={{ padding: '16px 24px 20px', display: 'flex', flexDirection: 'column', gap: 12 }}>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3" style={{ marginTop: 4 }}>
                            {[
                                ...
                                <div key={label} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 14px', background: 'var(--paper)', borderRadius: 12, border: '1.5px solid var(--rule)' }}>
                ...
                {/* ── Responses ── */}
                <section style={{ border: '2px solid var(--ink)', background: 'white', borderRadius: 20, boxShadow: '4px 4px 0 var(--ink)' }}>
                                ...
                                {responses.map((response: any, index: number) => (
                                    ...
                                    >
                                        <div style={{ display: 'flex', alignItems: 'center', gap: 12, minWidth: 0, flex: 1 }}>
                                            <div style={{ width: 36, height: 36, borderRadius: 999, border: '2px solid var(--ink)', background: response.answer === 'yes' ? 'var(--accent-hex)' : 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, boxShadow: '2px 2px 0 var(--ink)' }}>
                                                {response.answer === 'yes'
